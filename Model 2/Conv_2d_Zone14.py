...
save_path = saver.save(sess, "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 14 model.ckpt")

#last ran for 2820 steps

#saver.restore(sess,  "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 14 model.ckpt")
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_14_pred.csv", index=False)
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_13_pred.csv", index=False)