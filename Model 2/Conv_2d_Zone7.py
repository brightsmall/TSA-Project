...
def get_test_batch_right_leg():
    array_list=[]
    test_folder = "D:\\TSA\stage 1\\aps\\Zone 6\\test_mirror\\"
...
save_path = saver.save(sess, "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 7 model.ckpt")

#last ran for 2820 steps

#saver.restore(sess,  "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 7 model.ckpt")
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_7_pred.csv", index=False)
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_6_pred.csv", index=False)