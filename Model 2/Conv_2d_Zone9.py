...
save_path = saver.save(sess, "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 9 model.ckpt")

#last ran for 1400 steps

#saver.restore(sess,  "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 9 model.ckpt")
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_9_pred.csv", index=False)
