...
raw_df['Id'] = new_id
raw_df['Zone'] = zone
zone9_labels = raw_df[raw_df['Zone']=='Zone9']
zone9_labels.reset_index(inplace=True, drop=True)
...
pos_folder =  "D:\\TSA\\stage 1\\aps\\Zone 9\\pos\\"
neg_folder =  "D:\\TSA\\stage 1\\aps\\Zone 9\\neg\\"
test_folder = "D:\\TSA\\stage 1\\aps\\Zone 9\\test\\"
...
for i,item in enumerate(id_list):
    ...
    if zone9_labels['Id'].str.contains(item).any():
        label = int(zone9_labels[zone9_labels['Id']==item]['Probability'])
        if label == 1:
...
test_folder = "D:\\TSA\\stage 1\\aps\\Zone 9\\test_mirror\\"
