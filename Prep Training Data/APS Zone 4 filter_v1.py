...
raw_df['Id'] = new_id
raw_df['Zone'] = zone
zone4_labels = raw_df[raw_df['Zone']=='Zone4']
zone4_labels.reset_index(inplace=True, drop=True)
zone2_labels = raw_df[raw_df['Zone']=='Zone2']
zone2_labels.reset_index(inplace=True, drop=True)
...
for i,item in enumerate(id_list):
    ...
    if zone4_labels['Id'].str.contains(item).any():
        label = int(zone4_labels[zone4_labels['Id']==item]['Probability'])
        if label == 1:
...
for i,item in enumerate(id_list):
    ...
    if zone2_labels['Id'].str.contains(item).any():
        label = int(zone2_labels[zone2_labels['Id']==item]['Probability'])
        if label == 1:
