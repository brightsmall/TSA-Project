...
save_path = saver.save(sess, "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 10 model.ckpt")

#last ran for 2820 steps

#saver.restore(sess,  "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 10 model.ckpt")
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_10_pred.csv", index=False)
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_8_pred.csv", index=False)