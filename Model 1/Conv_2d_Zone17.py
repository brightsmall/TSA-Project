...
save_path = saver.save(sess, "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 17 model.ckpt")

#last ran for 1400 steps

#saver.restore(sess,  "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 17 model.ckpt")
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_17_pred.csv", index=False)
