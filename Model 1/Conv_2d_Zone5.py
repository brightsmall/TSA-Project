...
pos_folder =  "D:\\TSA\\stage 1\\aps\\Zone 5\\pos\\"
neg_folder =  "D:\\TSA\\stage 1\\aps\\Zone 5\\neg\\"
test_folder = "D:\\TSA\\stage 1\\aps\\Zone 5\\test\\"
...
#    array_list=[]
#    test_folder = "D:\\TSA\stage 1\\aps\\Zone 5\\test_mirror\\"
#   
#    for idx in range(len(test_ID_list)):
#        img_id = test_ID_list[idx]
...
save_path = saver.save(sess, "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 5 model.ckpt")

#last ran for 1400 steps

#saver.restore(sess,  "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 5 model.ckpt")
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_5_pred.csv", index=False)
