...
save_path = saver.save(sess, "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 3 model.ckpt")

#last ran for 2820 steps

saver.restore(sess,  "D:\\TSA\\stage 1\\aps\\Saved Models\\Zone 3 model.ckpt")
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_3_pred.csv", index=False)
...
pred_df.to_csv("D:\\TSA\\stage 1\\zone_1_pred.csv", index=False)